...
import styles from "./IconCardBorder.module.scss"

type IconCardBorderProps = {
  className?: string
}

export const IconCardBorder = (props: IconCardBorderProps) => {
    ...
    >
      <g filter="url(#filter0_b_21_442)">
        ...
        <path
          ...
          stroke="url(#paint0_linear_21_442)"
          stroke-opacity="0.7"
        />
      </g>
      <defs>
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_21_442"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_21_442"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_21_442"
          x1="161.09"
          y1="208.35"
          x2="14.5698"
          y2="-9.78639"
